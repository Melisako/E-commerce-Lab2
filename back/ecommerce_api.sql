...
--
-- Host: 127.0.0.1:3306
-- Generated on: Wed, 29 Jan 2024 at 10:33
...
--
-- Structure of the `commande` table
--
...
--
-- Dumping data from the `commande` table
--
...
(4, 'Kanto', 'ANDRIAHARINIAINA', 'III AB 50', 'Ivato', '101', 'CHèque ', 'Chaise', 'Wood and silk', '34'),
(2, 'Hardy', 'HERINAVALONA', 'III AB 50 A', 'IMERINA AFOVOANY', '102', 'Cash', 'Watch', 'Silver color', '1'),
(3, 'Miora', 'RAKOTOMALALA', 'III AB 50', 'Andrononobe', '101', 'Cheque', 'Headphones', 'Blue', '2');

-- --------------------------------------------------------

--
-- Structure of the `paiement` table
--
...
--
-- Dumping data from the `paiement` table
--
